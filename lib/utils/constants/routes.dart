...
import 'package:startup_boilerplate/views/profile/user_profile.dart';
import 'package:startup_boilerplate/views/repositories/repositories_screen.dart';

const String krSplashScreen = '/splash-screen';
const String krHome = '/home';
const String krRepositories = "/repositories";
...
List<GetPage<dynamic>>? routes = [
  GetPage(name: krSplashScreen, page: () => const SplashScreen(), transition: Transition.noTransition),
   ...
   GetPage(name: krRepositories, page: () => Repositories(), transition: Transition.noTransition),
   GetPage(name: krUserProfile, page: () => UserProfile(), transition: Transition.noTransition),
];